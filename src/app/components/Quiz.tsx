...
const level1Questions: Question[] = [
  ...
  { id: 2, question: "Which data structure organizes items in a FIFO manner?", options: ["Stack", "Queue", "Tree", "Graph"], answer: "Queue" },
  ...
  { id: 5, question: "Which of these processes is not typically involved in refining petroleum?", options: ["Fractional distillation", "Cracking", "Polymerization", "Filtration"], answer: "Filtration" },
];
  ...
  return (
    <div className="p-4 border rounded shadow-md bg-white">
      {!submitted ? (
        ...
        <p className="text-green-500 font-bold mt-4">Quiz Completed! Score: {score} / 10</p>
      )}
    </div>
  );
}
